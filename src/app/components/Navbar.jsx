        ...
        <div className=" md:w-auto" >
          {
            ...
            <li className="flex justify-center items-center gap-2">
              <FaWhatsapp/>
              <a
                href="https://wa.me/+6285939466976?text=Saya%20Ingin%20Memesan%20Klepon%20Anekanya%20Kak%20Tolong%20Dibalas%20Terima%20Kasih" target="_blank"
                className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-primary md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >
                Pesan via WA
              </a>
          ...
          <AiOutlineMenu className={`md:hidden flex text-3xl ${menuMobile ? "text-white" : "text-green-700"} z-20 relative`} onClick={navHandler}/>
        </div>
      </div>
    </nav>
  );
